...
1) Download boost 1.57.0 from http://sourceforge.net/projects/boost/files/boost/1.57.0/ to folder <project directory>\share.
2) Unpack it to <project directory>\share\boost_1_57_0
2) cd <project directory>\share\boost_1_57_0
3) Run bootstrap.bat
