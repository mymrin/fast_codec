...
1) Download boost 1.60.0 from http://sourceforge.net/projects/boost/files/boost/1.60.0/ to folder <project directory>\share.
2) Unpack it to <project directory>\share\boost_1_60_0
2) cd <project directory>\share\boost_1_60_0
3) Run bootstrap.bat
